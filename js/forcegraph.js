function forcegraph(selector) {
    ...
    var force2 = d3.forceSimulation()
        ...
        .force("gravity", d3.forceManyBody(0.2))
        .alpha(1)
        .force("center", d3.forceCenter(width / 2, height / 2))
        .force("link", d3.forceLink().id(function(d) { return d.key }).distance(170));
    computeNodes();
...
/// The second force directed layout ***********
    ...
    node2.append("text")
        ...
        .style("fill", function (d) {
            return colorsw(categories.indexOf(d.group));
        })
...
function computeNodes() {
    ...
    var numNode = Math.min(15, nested_data.length);
